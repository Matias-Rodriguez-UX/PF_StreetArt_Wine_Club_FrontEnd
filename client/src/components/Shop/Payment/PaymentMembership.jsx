...
import { getUserAddresses, createUserAddress, getUserInfo, getAllCities, assignMemberships } from "../../../actions/userActions";
...
export default function PaymentMembership() {
    ...
    const total = storedMembership.price
    ...
    }, [dispatch, isAuthenticated, userInfo.id, total])
    ...
    const addMemberships = () => {
        for (const membership of userInfo?.memberships) {
            currentMembership.push(membership.id)
        }
    }
        ...
        <>
            ...
            <div className="container d-flex flex-wrap col align-items-center gap-2 mt-4">
                <div className="container-fluid w-100 d-flex align-items-center">
                    <Link to={'/memberships'} className='text-decoration-none text-reset'><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-arrow-left me-2" viewBox="0 0 16 16">
                        <path fillRule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8z" />
                    </svg>Back to Memberships</Link>
                </div>
                <div className="container d-flex align-items-start gap-5 mt-4">
                    <div className="col-md-4 order-md-2 mb-4">
                        <h4 className="d-flex justify-content-between align-items-center mb-3">
                            <span className="text-muted">Your Memebership</span>
                        ...
                        <ul className="list-group mb-3">
                            ...
                            <li className="list-group-item d-flex justify-content-between lh-condensed">
                                <div>
                                    <h6 className="my-0">{storedMembership.name}</h6>
                                </div>
                                <span className="text-muted">${storedMembership.price}.00-</span>
                            </li>

                            <li className="list-group-item d-flex justify-content-between">
                                <div className='d-flex align-items-center gap-5'><p className="fs-5 fw-bold">Total: </p><p className="fs-5 fw-bold">${total}.00-</p></div>
                            </li>
                        </ul>
